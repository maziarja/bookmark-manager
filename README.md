...
When adding a new bookmark, extract the site's favicon automatically based on the URL. How you save this is up to you. Alternatively, you can add a file upload input in the add/edit bookmark form to allow the user to add the favicon/logo manually.
